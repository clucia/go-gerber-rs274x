...
func (graphicsStateChange *GraphicsStateChange) ProcessDataBlockToolpath(camo *CamOutput, gfxState *GraphicsState) error {
	graphicsStateChange.ProcessDataBlockSurface(nil, gfxState)
	return nil
}
