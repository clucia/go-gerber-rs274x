...
func (apertureDefinition *ApertureDefinitionParameter) ProcessDataBlockToolpath(camo *CamOutput, gfxState *GraphicsState) error {
	apertureDefinition.ProcessDataBlockSurface(nil, gfxState)
	return nil
}
